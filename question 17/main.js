...
for (var j = 0; j < guest_list.length; j++) {
    console.log(console.log("assalamualaikum! dear ".concat(guest_list[j], ": \n you are invited at dinner \n")));
}
;
console.log(guest_list);
//message to inform
console.log(" \"dear frinds ".concat(guest_list, " ASSALAMUALAIKUM \n unfortunatly dinner table is not arriving at time so i m inviting omly two frinds \n \""));
//making new list
guest_list.pop();
guest_list.pop();
guest_list.pop();
...
for (var k = 0; k < guest_list.length; k++) {
    console.log(" ".concat(guest_list[k], " you are invited at dinner"));
}
//empty list
guest_list.pop();
guest_list.pop();
