...
var likeToVisit = ["MAKKAH", "PHELISTINE", "EGYPT", "JORDAN"];
...
console.log("alphabatical order " + __spreadArray([], likeToVisit, true).sort());
//• Show that your array is still in its original order by printing it.
console.log(likeToVisit);
/** */ /*Print your array in reverse alphabetical order without changing the order of the original list.*/
console.log("reverse alphabatical order  " + __spreadArray([], likeToVisit, true).sort().reverse());
